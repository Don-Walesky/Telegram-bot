...
| [`handlers/slip_handlers.py`](file:///c:/Users/WALE/TELEGRAM-bot/handlers/slip_handlers.py) | Handles 5-step interactive Bet Builder wizard (/custom) and wizard callback state machine. | `builder`, `database`, `keyboards` | **LOW** | Bet Builder Telegram UI Handlers |
